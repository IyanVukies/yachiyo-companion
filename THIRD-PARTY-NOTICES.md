...
Yachiyo Companion 0.2.1 is an unlicensed/private project wrapper around several third-party components. This summary is not legal advice and does not replace the license files shipped with dependencies.
